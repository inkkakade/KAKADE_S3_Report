...
%    end
   ...
   %if A_old - A > 0
        [Kcc,Kce, Kce_pr,Kee, Kee_pr, Fe, Fe_pr,Fc,K_cnd,F_cnd,compliance_truss, u_c, coupling_dofs_truss] = truss_stiffness_condensation_by_set(nelx,nely,E0,xval(end-4),...
